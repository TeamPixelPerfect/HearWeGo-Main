...
const ArtistSignUp = () => {
  ...
  const handleStageSeven = () => {
    ...
    console.log("Verification Document:::", verDoc);
    ...
    handleArtistRegister({ ...artistDetails, verificationDocuments: [verDoc] }).then((res) => {
      if (res) {
        ...
        setSnackbarMessage("Failed to submit documents!");
      }
    });
  };
