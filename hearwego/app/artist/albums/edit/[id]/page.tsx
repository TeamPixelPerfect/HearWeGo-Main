...
const AddAlbumData = ({ params: { id } }: Props) => {
  ...
  const handleAddAlbumData = () => {
    ...
    updateAlbum(
      ...
      albumData?._id as string,
      albumData
    ).then((res) => {
      console.log(res);
      setUploading(false);
      Router.push("/artist/albums/" + albumData?.album_id);
    });
  };
                ...
                <CustomTabPanel value={value} index={0}>
                  <Box sx={{ width: "100%", display: "flex" }}>
                    ...
                    <Box sx={{ width: "50%", marginLeft: "100px" }}>
                      ...
                      >
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                          <DemoContainer components={[" DatePicker"]}>
                            <DatePicker
                              label="Release Date"
                              value={dayjs(albumData?.release_date)}
                              onChange={(value: any) => {
                                const date = value
                                  .format("YYYY-MM-DD")
                                  .toString();
                      ...
                      >
                        {albumData?.album_genre && (
                          <Autocomplete
                            multiple
                            disablePortal
                            id="album_genres"
                            defaultValue={albumData?.album_genre}
                            options={genres}
