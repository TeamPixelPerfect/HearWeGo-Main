...
import { addSong, getSong, updateSong } from "@/app/services/SongServices";
...
const AddSongData = ({ params: { id } }: Props) => {
                      ...
                      <div style={{ marginTop: "30px", marginLeft: "20px" }}>
                        <FormControl>
                          ...
                          <RadioGroup
                            ...
                            value={songData?.privacy_status as string}
                            onChange={(e, value) => {
                              setSongData((data) => {
  ...
  return (
    <>
      <Autocomplete
        multiple
        id="languageTag"
        defaultValue={songData?.language}
...
function ReleaseDate({ songData, setSongData, error }: InputProps) {
  const handleChange = (e: any) => {
    ...
    console.log("Date:::", date, songData?.release_date);
    setSongData((data) => {
  ...
  return (
    <TextField
      type="date"
      label="Release Date"
      value={songData?.release_date?.split("T")[0]}
      format="LL"
      variant="filled"
      sx={{ width: "90%" }}
      onChange={handleChange}
  ...
  return (
    <>
      <Autocomplete
        multiple
        id="artistTag"
        defaultValue={songData?.artist?.map((artist: any) => artist.artist_name)}
        options={artists}
  ...
  return (
    <>
      <Autocomplete
        multiple
        id="composerTag"
        defaultValue={songData?.composer?.map((artist: any) => artist.artist_name)}
        options={composers}
        filterOptions={handleFilter}
        // defaultValue={[top100Films[12].title, top100Films[13].title]}
        // readOnly
  ...
  return (
    <>
      <Autocomplete
        multiple
        id="artistTag"
        defaultValue={songData?.song_writers?.map((artist: any) => artist.artist_name)}
        options={writers}
        filterOptions={handleFilter}
        // defaultValue={[top100Films[12].title, top100Films[13].title]}
        // readOnly
