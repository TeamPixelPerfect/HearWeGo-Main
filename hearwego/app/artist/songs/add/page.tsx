...
const AddSong = () => {
    ...
    return (
        <><div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', padding: '10px', borderRadius: '15px' }}>
            <div style={{ marginBlockEnd: '80px', display: 'flex', width: '90%', maxWidth: '800px', background: 'white', borderRadius: '15px', justifyContent: 'center', marginTop: '20px' }}>
        ...
        {isDragActive ? (
            ...
            <DropSong
                ...
                aspectY={1}
                shape='rect' />
            <div style={{ width: '90%', maxWidth: '800px',marginTop:'20px',marginLeft:'50px'}}>
                <FormControl>
            ...
            <p style={{ width: '90%', maxWidth: '800px', textAlign: 'center' }}>Supported file types and sizes - Upload troubleshooting tips - Copyright FAQs
                By uploading, you confirm that your sounds comply with our Terms of Use and you don't infringe anyone else's rights.

                Legal - Privacy - Cookies - Imprint - Creator Resources - Blog - Charts - Popular searches</p>
