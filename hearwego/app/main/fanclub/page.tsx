...
<Paper
    ...
    >
      <IconButton sx={{ p: '10px',position:'fixed' }} aria-label="menu">
      ...
      />
      <IconButton type="button" sx={{ p: '10px',position:'fixed', right:0}} aria-label="search">
        <SearchIcon />
      </IconButton>
  
      <IconButton color="primary" sx={{ p: '10px',position:'fixed' }} aria-label="directions">
    ...
    >
      ...
      <Box
       ...
       <i>2024-01-25</i>
        ...
        >
        <p>Snow storm coming in Sommaroy island, Arctic Norway. This is
            something that you definitely wanna see in your life.</p>
        </Box>
